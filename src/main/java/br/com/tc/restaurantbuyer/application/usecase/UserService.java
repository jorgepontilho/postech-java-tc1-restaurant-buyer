...
import br.com.tc.restaurantbuyer.application.port.out.repository.UserRepository;
...
public class UserService implements UserUseCase {
    ...
    /*----------------------- MAPPERS -----------------------*/
    @Override
    public UserDTO toUserClientDTO(UserClient userClient) {
        return new UserDTO(
                userClient.getId(),
                userClient.getLogin(),
                userClient.getRole(),
    ...
    @Override
    public UserClient toUserClient(UserDTO userDTO) {
